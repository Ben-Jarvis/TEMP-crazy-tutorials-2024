...
3. Now you need to tune your gains. Include the tuning functions that are provided **self.tuning(min,max,duration,dt,setpoint,sensor_measurement, "message for plotting")**. They will send step inputs to your drone and plot the most important metrics for tuning.
...
Our best time is 16 s. Let the fastest drone win!
